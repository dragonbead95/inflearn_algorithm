...
public class MaxHeap {
	...
	public static void push(List<Integer> data, int key)
	{
		data.add(key);
		HeapSort(data);
	}
	
	public static int poll(List<Integer> data)
	{
	...
	public static void main(String[] args) {
		...
		System.out.println("삽입 전 : " + data);
		push(data, 11);
		System.out.println("삽입 후 : " + data);
		
		System.out.println("추출 전 : " + data);
		System.out.println(poll(data));
		System.out.println("추출 후 : " + data);
